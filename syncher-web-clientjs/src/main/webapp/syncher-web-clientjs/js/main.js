...
require(
        [
                'knockout',
                'bennu-knockout',
                'viewModels/SyncLogsViewModel',
                'models/RemainingSyncEvents',
                'models/SyncLogsRelational',
                ...
                'jquery' ],
        function(
                ko, bennuKo, SyncLogsViewModel, RemainingSyncEvents, SyncLogsRelational, LogViewModel, NavbarViewModel,
                AppUtils, SyncLogsInitializer, $) {
            // --
            ...
            navbarViewModel.fetchData(function() {
